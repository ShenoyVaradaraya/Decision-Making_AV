...
for episode in range(0, params.max_episode):    # simulation will be runned 1 time
    ...
    plt.close               # corresponds to close all of matlab, but need to check
    ...
    for step in range(0, max_step):
        ...
        speed_over_time.append(X_new[3,1])
        X_old = X_new
        ...
        plot_velocity.plot_velocity(speed_over_time,params,step,max_step,fig_vt)
        # Timer
        t1 = time.time()
        time_per_step = t1 - t0
        # print(time_per_step)
